 ...
 *   from src/index.css (:root + .dark), and the first-run default again
 *   (see DEFAULT_THEME_ID); graphite, amber, and monochrome remain
...
export const DEFAULT_THEME_ID = "mocha-mousse";
