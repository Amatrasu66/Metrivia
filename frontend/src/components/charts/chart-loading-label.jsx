...
// NOTE (Metrivia): the registry ships this as "../components/shimmering-text",
// but the shadcn CLI installs shimmering-text.jsx next to this charts folder,
// so the import below points at the installed location.
